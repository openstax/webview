define (require) ->
  ...
  ProcessingInstructionsModal = require('cs!modules/media/body/processing-instructions/modals/processing-instructions')
  SimModal = require('cs!modules/media/body/embeddables/modals/sims/sims')
  template = require('hbs!modules/media/body/body-template')
  require('less!./body')

  embeddableTemplates =
    'exercise': require('hbs!../../../media/body/embeddables/exercise-template')
    'iframe': require('hbs!../../../media/body/embeddables/iframe-template')

  fakeExerciseTemplates = [
    require('hbs!../../../media/body/embeddables/fake-exercises/ex001')
    require('hbs!../../../media/body/embeddables/fake-exercises/ex002')
    require('hbs!../../../media/body/embeddables/fake-exercises/ex003')
    require('hbs!../../../media/body/embeddables/fake-exercises/ex004')
  ]

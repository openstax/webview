define (require) ->
  ...
  WindowWithPreferencesView = require('cs!modules/window-with-preferences/window-with-preferences')
  ...
  return class MediaView extends BaseView
    ...
    onRender: () =>
      ...
      WindowWithPreferences = new WindowWithPreferencesView()
      ...
      @regions.media.append(WindowWithPreferences)

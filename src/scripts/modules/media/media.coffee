define (require) ->
  ...
  WindowWithRightSidebarView = require('cs!modules/window-with-right-sidebar/window-with-right-sidebar')
  ...
  return class MediaView extends BaseView
    ...
    onRender: () =>
      ...
      WindowWithRightSidebar = new WindowWithRightSidebarView()
      ...
      @regions.media.append(WindowWithRightSidebar)

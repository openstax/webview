(function () {
  ...
  var tsNowString = '?ts=' + new Date().valueOf();
  ...
  require.config({
    ...
    paths: {
      ...
      OpenStaxConceptCoach: coachBasePath + 'dist/full-build.min.js' + tsNowString,
    ...
    shim: {
      ...
      OpenStaxConceptCoach: {
        deps: ['css!' + coachBasePath + 'assets/main.css' + tsNowString],

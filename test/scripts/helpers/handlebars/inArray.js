describe('handlebars in array helper tests', function () {
  ...
  var inArray, Handlebars,
    myOptions = { fn: function(obj) {return obj.date('12/11/2012').toString();},
                  inverse: function(obj) {return obj.author([{author: 'Caroline'}], 0, 'author').toString();}
                };
  ...
  it ('should evaluate array and value', function() {
    var myArray = function() {return [1,2,3];};
    var myValue = function() {return 3;};

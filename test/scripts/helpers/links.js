describe('links helper tests', function () {
  ...
  describe('get path tests', function () {
    it('should return the root url', function() {
      // not content
      var page = 'nothing';
      var data = {model: {getVersionedId: function(){return 'not real';}}};
    ...
    it('should append uuid from settings to url', function(){
      var page = 'contents';
      var data = {model: {getVersionedId: function(){return '031da8d3-b525-429c-80cf-6c8ed997733a@8.1';}}};

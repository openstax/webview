describe('backbone base view helper tests', function () {
  ...
  describe('get template data tests', function () {
    it('should get template data from models and collections', function () {
      var myBase = new BaseView();
      // has a toJSON method
      myBase.model = new Date(2014, 1, 1);
      myBase.getTemplateData().should.equal('2014-02-01T06:00:00.000Z');
      myBase.collection = new Date(2013, 4, 5);
      myBase.getTemplateData().should.equal('2014-02-01T06:00:00.000Z');
      myBase.model = undefined;
      myBase.getTemplateData().should.equal('2013-05-05T05:00:00.000Z');
    });
